...
THREE.FirstPersonControls = function (object, domElement) {
    ...
    this.onKeyDown = function (event) {
        switch (event.keyCode) {
            ...
            case 16: /* shift */ this.running = true;
    ...
    this.onKeyUp = function (event) {
        switch (event.keyCode) {
            ...
            case 16: /* shift */ this.running = false;
            // pass other events to game
    ...
    this.cameraMove = function (delta) {
        ...
        var speed = this.running ? $s.moveFastSpeed : $s.moveSlowSpeed;
        var dx = delta * speed;
        ...
        var x = this.object.position.x + dx * v.x
        var z = this.object.position.z + dx * v.z
        return [x, z];
    };
